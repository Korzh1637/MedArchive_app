 ...
 **/FastAPI - API для взаимодействия между интерфейсом и backend'ом**
 В основном, синхронизация данных на сервере с данными в локальной базе данных на устройстве.
