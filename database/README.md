...
# Запуск тестов (пока только для users)
Тесты проверяют все существующие методы для пользователей. Для проверки необходимо запускать из директории MedArchive_app/
